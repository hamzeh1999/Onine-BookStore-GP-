...
class _BookModificationPageState extends State<BookModificationPage> {
  ...
  final TextEditingController _desicriptiontextEditingController = TextEditingController();
  final TextEditingController _statustextEditingController = TextEditingController();
                      ...
                      children: [
                        InkWell(
                          ...
                          child: CircleAvatar(
                            ...
                            child: file1 == null ?  Image.network(widget.itemModel.thumbnailUrl[1]) : null,
                          ),
                        ),
                        ...
                        InkWell(
                          ...
                          child: CircleAvatar(
                            ...
                            child: file2 == null ?  Image.network(widget.itemModel.thumbnailUrl[2]) : null,
                          ),
                        ),
                        SizedBox(width: screenSize.width*0.05,),
                        ...
                        InkWell(
                          ...
                          child: CircleAvatar(
                            ...
                            child: file3 == null ?  Image.network(widget.itemModel.thumbnailUrl[3]) : null,
                          ),
                        ),
                        SizedBox(width: screenSize.width*0.05,),
                        ...
                        InkWell(
                          ...
                          child: CircleAvatar(
                            ...
                            child: file4 == null ? Image.network(widget.itemModel.thumbnailUrl[4]) : null,
                          ),
                        ),
  ...
  updatePhotoToFirebase(Book model,File image,File image1,File image2,File image3,File image4) async {
      ...
      if(image!=null) {
        ...
        StorageUploadTask uploadTask =  storageReference.child(
            "product_${model.bookId} 0.jpg").putFile(image);
      ...
      if(image1!=null)
      {
        ...
        StorageUploadTask uploadTask1 = storageReference.child("product_${model.bookId} 1.jpg").putFile(image1);
      ...
      if(image2!=null)
      {    print("image2.............................................................");
      StorageUploadTask uploadTask2 = storageReference.child("product_${model.bookId} 2.jpg").putFile(image2);
      ...
      StorageUploadTask uploadTask3 = storageReference.child("product_${model.bookId} 3.jpg").putFile(image3);
      ...
      if (image4 != null) {
        ...
        StorageUploadTask uploadTask4 = storageReference.child(
            "product_${model.bookId} 4.jpg").putFile(image4);
  ...
  changeBookData(Book model) async
  {
    ...
    if (_nametextEditingController.text.isNotEmpty) {
      await Firestore.instance
          .collection("Books")
          .document(model.bookId).updateData({
        'title': _nametextEditingController.text.toUpperCase(),
        "caseSearch": setSearchParam(
            _nametextEditingController.text.toUpperCase()),
      })
          .then((value) {
        SignChange = true;
    ...
    if (_statustextEditingController.text.isNotEmpty) {
      await Firestore.instance
          .collection("Books")
          .document(model.bookId).updateData({
        'status': _statustextEditingController.text
      })
          .then((value) {
        SignChange = true;
...
//     Firebase.i.collection("Rooms").doc("bsYNIwEkjP237Ela6fUp").collection("Messages");

     await Firestore.instance
         .collection("Books")
         .document(model.bookId).delete()
         .then((value) {
       print("User Updated in fireStore");
